...
class ProductTemplate(models.Model):
    ...
    unidad_medida = fields.Selection(selection=UNIDAD_MEDIDA_LIST, string='Unidad SAT',default='Pieza')
    clave_producto = fields.Char(string='Clave producto',default='43211500')
